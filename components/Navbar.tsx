      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900 text-sm">Facilitadores</span>
          </Link>
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="ml-2 flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium bg-gray-900 text-white hover:bg-gray-700 transition-colors"
            >
